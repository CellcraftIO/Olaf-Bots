...
setTimeout(function() {
    ...
    window.aRm3gK2Ogm = function() {
        return {
            readyState: 0
        }
    };
    window.AgK5fn9Lgau = window.WebSocket = function(ip) {
        return new window.aRm3gK2Ogm(ip);
    };
    window.aYbm28lPgj43 = {};
    ...
    $("#instructions")
        .replaceWith('<br><div class="input-group"><span class="input-group-addon" id="basic-addon1">UUID</span><input type="text" value="' + client_uuid + '" readonly class="form-control"</div>');
    ...
    function emitPosition() {
        ...
        document.getElementById('gh45nmvsy')
            .innerHTML = (~~(window.aYbm28lPgj43.mx - window.aYbm28lPgj43.ma)) + "," + (~~(window.aYbm28lPgj43.my - window.aYbm28lPgj43.mb));
    }
    ...
    document.addEventListener('keydown', function(e) {
        ...
        switch (key) {
            ...
            case 65:
                ...
                document.getElementById('ismoveToMouse')
                    .innerHTML = window.aYbm28lPgj43.p;
                break;
            case 67:
                window.aYbm28lPgj43.q = !window.aYbm28lPgj43.q;
                if (window.aYbm28lPgj43.q) {
                    document.getElementById('dfdghehfj')
                        .innerHTML = "On";
                } else {
                    document.getElementById('dfdghehfj')
                        .innerHTML = "Off";
